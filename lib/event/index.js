...
class Event{
    ...
    addEventListener(event, fun, useCapture=false){
        let _this = this;
        function closure(e){
            fun(e, _this);
        }
        this.rootDom.addEventListener(event, closure, useCapture);
    }
    removeEventListener(event, fun, useCapture=false){
        this.rootDom.removeEventListener(event, fun, useCapture);
    }
    mousedown(e, _this){
        let obj = new Object();
        obj['pageX'] = e.pageX;
