...
function sizeBoxAdjust(e){
    console.log(e, this)
    if(e.path[3].parentNode == window.artText.container && e.path[1].childNodes[1].nodeName == "SPAN"){
        if(e.path[1].childNodes[1].style.display === "none"){
            e.path[1].childNodes[1].style.display = "inline";
            let values = getTableSize(e.path[3].nextSibling);
            e.path[1].childNodes[1].childNodes[0].value = values[0];
            e.path[1].childNodes[1].childNodes[1].value = values[1];
        }else{
            setTableSize(e.path[3].nextSibling, [e.path[1].childNodes[1].childNodes[0].value, e.path[1].childNodes[1].childNodes[1].value]);
...
function delTable(e){
    if(e.path[3].parentNode == window.artText.container){
        if(e.path[3].nextSibling && e.path[3].nextSibling.nodeName == "TABLE"){
            e.path[3].nextSibling.parentNode.removeChild(e.path[3].nextSibling);
