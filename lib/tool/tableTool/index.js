...
function sizeBoxAdjust(e){
    console.log(e, this)
    if(e.path[2].parentNode == window.artText.container.childNodes[0] && e.path[1].childNodes[1].nodeName == "SPAN"){
        if(e.path[1].childNodes[1].style.display === "none"){
            e.path[1].childNodes[1].style.display = "inline";
            let values = getTableSize(e.path[2].nextSibling);
            e.path[1].childNodes[1].childNodes[0].value = values[0];
            e.path[1].childNodes[1].childNodes[1].value = values[1];
        }else{
            setTableSize(e.path[2].nextSibling, [e.path[1].childNodes[1].childNodes[0].value, e.path[1].childNodes[1].childNodes[1].value]);
...
function delTable(e){
    console.log(e)
    if(e.path[2].parentNode == window.artText.container.childNodes[0]){
        if(e.path[2].nextSibling && e.path[2].nextSibling.nodeName == "TABLE"){
            e.path[2].nextSibling.parentNode.removeChild(e.path[2].nextSibling);
