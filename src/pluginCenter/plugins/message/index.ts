...
export default class Message {
    static DEFAULT_CSS: string = '.art-tool-message-body{overflow:hidden;box-shadow: 0 2px 12px 0 rgba(0, 0, 0, 0.1);border-radius: 4px;left: 50%;margin: -27px 0 0 -170px;position: fixed;position: fixed !important;top: 40px;height: 40px;line-height: 40px;width: 340px;padding: 1px 10px 1px 15px;transition: opacity .3s,transform .4s,top .4s,-webkit-transform .4s;z-index: 1000;}'
    static Name = 'Message';
     ...
     */
    create(message: string, type: string = 'null') {
