...
export class TableTool {
    ...
    private createAlignSpan(): HTMLSpanElement {
        ...
        left.setAttribute('class', 'art-buttonTool-hover');
        left.onclick = this.align('left');
        left.innerHTML = '左';
        let center = document.createElement('button');
        center.setAttribute('class', 'art-buttonTool-hover');
        center.onclick = this.align('center');
        center.innerHTML = '中';
        let right = document.createElement('button');
        right.setAttribute('class', 'art-buttonTool-hover');
    ...
    private createAdjustSpan(): HTMLSpanElement {
        ...
        sizeSpan.setAttribute('class', 'art-buttonTool-hover');
    ...
    private createMoreButton() {
        ...
        more.setAttribute('class', 'art-buttonTool-hover');
